defmodule MvpApiWeb.InnovationProjectControllerTest do
  ...
  describe "create innovation_project" do
    test "renders innovation_project when data is valid", %{conn: conn} do
      conn = post(conn, Routes.innovation_project_path(conn, :create), innovation_project: @create_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn = post(conn, Routes.innovation_project_path(conn, :create), innovation_project: @invalid_attrs)
  ...
  describe "update innovation_project" do
    ...
    test "renders innovation_project when data is valid", %{conn: conn, innovation_project: %InnovationProject{id: id} = innovation_project} do
      conn = put(conn, Routes.innovation_project_path(conn, :update, innovation_project), innovation_project: @update_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn, innovation_project: innovation_project} do
      conn = put(conn, Routes.innovation_project_path(conn, :update, innovation_project), innovation_project: @invalid_attrs)
      assert json_response(conn, 422)["errors"] != %{}
    end
  end
  ...
  describe "delete innovation_project" do
    ...
    test "deletes chosen innovation_project", %{conn: conn, innovation_project: innovation_project} do
